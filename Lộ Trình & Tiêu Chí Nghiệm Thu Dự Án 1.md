...
**- https://drive.google.com/drive/folders/1vWQKBfddgK5 ZAKcDLEDidVlIn4_GoF1**
...
- Hệ thống Object Pooling hoạt động ổn định, không phát sinh lỗi rò rỉ bộ nhớ (Memory
...
- Chỉ số GC Alloc tiệm cận về 0 trong quá trình chơi thông thường (không sinh rác trong Update).

- Tổng số Batches (Draw Calls) hiển thị trên cửa sổ Profiler luôn dưới mức khống chế 50 Batches.
